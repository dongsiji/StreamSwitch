...
// Modified from ZkJobCoordinator

public class FollowerJobCoordinator implements JobCoordinator {
    private static final Logger LOG = LoggerFactory.getLogger(FollowerJobCoordinator.class);
    ...
    FollowerJobCoordinator(Config config, MetricsRegistry metricsRegistry, ZkUtils zkUtils, String containerId) {
        ...
        this.barrier =  new ZkBarrierForVersionUpgrade(zkUtils.getKeyBuilder().getJobModelVersionBarrierPrefix(), zkUtils, new FollowerJobCoordinator.ZkBarrierListenerImpl(), debounceTimer);
